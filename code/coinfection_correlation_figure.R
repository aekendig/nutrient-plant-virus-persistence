## Goal: figure of concentrations from coinfection
...
# import data
cdat <- read_csv("./output/concentration_analysis_coinfection_data.csv")
...
#### figure ####
pdf("./output/figure_2_coinfection_correlation.pdf", width = 3, height = 3)
