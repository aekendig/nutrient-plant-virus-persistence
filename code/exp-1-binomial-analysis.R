...
# import data
dat <- read_csv("./output/exp-1-concentration-analysis-all-data.csv")
...
# save data
write_csv(datp, "./output/exp-1-binomial-analysis-pav-data.csv")
write_csv(datr, "./output/exp-1-binomial-analysis-rpv-data.csv")
...
# save model
save(m.bu.p, file = "./output/exp-1-binomial-analysis-uninformative-pav.rda")
...
# save model
save(m.bu.r, file = "./output/exp-1-binomial-analysis-uninformative-rpv.rda")
...
# save model
save(m.bi.p, file = "./output/exp-1-binomial-analysis-informative-pav.rda")
...
# save model
save(m.bi.r, file = "./output/exp-1-binomial-analysis-informative-rpv.rda")
